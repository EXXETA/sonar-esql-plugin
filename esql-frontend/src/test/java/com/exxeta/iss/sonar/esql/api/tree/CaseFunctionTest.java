...
public class CaseFunctionTest extends EsqlTreeModelTest<CaseFunctionTreeImpl> {
	...
	public void modelTest() throws Exception{
		CaseFunctionTreeImpl tree = parse("CASE CurrentMonth " + "WHEN '01' THEN 'January' " + "WHEN '02' THEN 'February' "
						+ "WHEN '03' THEN 'March' " + "WHEN '04' THEN 'April' " + "WHEN '05' THEN 'May' "
