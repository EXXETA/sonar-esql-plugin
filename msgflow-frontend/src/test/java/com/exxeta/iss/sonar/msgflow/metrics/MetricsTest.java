...
public class MetricsTest {
	...
	public void complexity() {
		...
		final Tree tree = parseMsgflow(new File(path));
	...
	public void nodes() {
		...
		final Tree tree = parseMsgflow(new File(path));
		assertThat(new CounterVisitor(tree).getNodeNumber()).isEqualTo(0);
	}

	private MsgflowTree parseMsgflow(final File file) {
