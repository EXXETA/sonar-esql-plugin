 ...
 * if more than one variable of same dataype is found uninitialised then declare statement could be combined.
 * 
 * 
	  ...
	  public void test() {
			 EsqlCheckVerifier.issues(new DeclareCombineCheck(), new File("src/test/resources/declareCombine.esql"))
			   ...
			   .next().atLine(18).withMessage("If  more than one variable of same datatype is found uninitialised then declare could be combined.")
			    ...
			    .next().atLine(31).withMessage("If  more than one variable of same datatype is found uninitialised then declare could be combined.")
			    ...
			    .next().atLine(54).withMessage("If  more than one variable of same datatype is found uninitialised then declare could be combined.")
			    .noMore();
